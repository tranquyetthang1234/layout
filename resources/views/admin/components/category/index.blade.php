    ...
    <div class="row mb-30">
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h5 class="kt-portlet__head-title title-custom title-form">
                                Thêm Danh Mục
                            </h5>
                        </div>
                    </div>
                    <div class=" kt-portlet__body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name"  placeholder="Tên danh mục" v-model="snippet.title">
                        </div>
                        <div class="form-group">
                            <label style="font-size: 15px;">Mô tả</label>
                            <textarea placeholder="Mô tả" class=" form-control" style="width:100%" id="" cols="30" name="description"
                                rows="10" v-model="snippet.description"></textarea>
                        </div>
                        <div class="form-group">
                            <label style="font-size: 15px;font-weight: 700;">Ảnh</label>
                        </div>
                        <div id="wp-category">
                        ...
                        <div class="form-group text-right">
                            <button class="btn btn-primary btn_save_cat" onclick="createCategory()" >Lưu</button>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="col-sm-6 col-lg-7">
          <div class=" kt-portlet kt-portlet--mobile card card-statistics h-100">
                <div class="kt-portlet__head">
                    <div class="card-body kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title title-custom title-form">
                            Menu Danh Mục
                        </h3>
                    </div>
                </div>
                                        ...
                                        <li data-id="<?=$value->id?>" id="menuItem_<?=$value->id?> "
                                            ...
                                            <a href="javascript:void(0)"><?=$value->name?>
                                                <div class="kt-portlet__head-toolbar">
                                                    ...
                                                    <div>
                                                        <button data-toggle="modal" data-target="#kt_modal_edit_cat"
                                                            type="button" data-id="1" data-name="Chủ đề 1"
                                                            onclick="updateCategory(<?=$value->id?>)"
                                                            class="btn btn-clean btn-sm btn-icon btn-icon-md edit-cat">
                                                           <i style="font-size:17px" class="fa fa-gear"></i>
                                                        </button>
                                                    </div>
                                                    <div>
                                                        <button onclick="deleteCategory(<?=$value->id?>)" type="button"
                                                            data-id="1"
